...
/* harmony import */ var babylonjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! babylonjs */ "./node_modules/_babylonjs@4.1.0@babylonjs/babylon.js");
...
/* harmony import */ var _style_page_index_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../style/page_index.css */ "./style/page_index.css");
/* harmony import */ var _style_page_index_css__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_style_page_index_css__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _layout_Ske__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../layout/Ske */ "./layout/Ske.jsx");
/* harmony import */ var mobx_react__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! mobx-react */ "./node_modules/_mobx-react@6.1.8@mobx-react/dist/mobxreact.esm.js");
...
var Juicy = (_dec = Object(mobx_react__WEBPACK_IMPORTED_MODULE_12__["inject"])("store"), _dec(_class = Object(mobx_react__WEBPACK_IMPORTED_MODULE_12__["observer"])(_class = (_temp =
/*#__PURE__*/
function (_React$Component) {
  ...
  function Juicy(props) {
    ...
    _this.createTexture = function (scene) {
      //尝试创建材质
      var tex = new babylonjs__WEBPACK_IMPORTED_MODULE_7__["StandardMaterial"]("mt", scene); //tex.emissiveColor = new BABYLON.Color3(1,0,1) //红色 emmissive 代表本身的颜色 RGB

      tex.diffuseColor = new babylonjs__WEBPACK_IMPORTED_MODULE_7__["Color3"](1, 0, 0); //绿色 漫反射
    ...
    _this.createScene = function (eng, canvas) {
      var scene = new babylonjs__WEBPACK_IMPORTED_MODULE_7__["Scene"](eng); //scene.ambientColor= new BABYLON.Color3(1,1,1);

      var camera = new babylonjs__WEBPACK_IMPORTED_MODULE_7__["FreeCamera"]("camera1", new babylonjs__WEBPACK_IMPORTED_MODULE_7__["Vector3"](10, 10, 0), scene); //let camera =  new BABYLON.ArcRotateCamera('c2',Math.PI/2, 0, 10,new BABYLON.Vector3.Zero(),scene);

      camera.setTarget(new babylonjs__WEBPACK_IMPORTED_MODULE_7__["Vector3"](0, 0, 0)); //设定你要朝向哪个方向
      ...
      {
        var light = new babylonjs__WEBPACK_IMPORTED_MODULE_7__["PointLight"]("light1", new babylonjs__WEBPACK_IMPORTED_MODULE_7__["Vector3"](0, 5, 0), scene);
        light.diffuse = new babylonjs__WEBPACK_IMPORTED_MODULE_7__["Color3"](1, 1, 0); //光的基本颜色
        //light.specular = new BABYLON.Color3(0, 0, 1);
      } //light.specular = new BABYLON.Color3(1,1,1);

      var ground = babylonjs__WEBPACK_IMPORTED_MODULE_7__["MeshBuilder"].CreateGround("jude", {
        width: 8,
        height: 8
      });
    ...
    _this.canvasRef = react__WEBPACK_IMPORTED_MODULE_5___default.a.createRef();
    _this.canvasShadow = react__WEBPACK_IMPORTED_MODULE_5___default.a.createRef();
    return _this;
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Juicy, [{
    ...
    value: function render() {
      return __jsx(_layout_Ske__WEBPACK_IMPORTED_MODULE_11__["default"], {
        __source: {
...
//# sourceMappingURL=index.js.3704b83ed254e1bb46a5.hot-update.js.map